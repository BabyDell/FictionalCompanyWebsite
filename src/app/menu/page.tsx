...
const cards = [
  {
    id: 1,
    title: "Appetizers",
    imageUrl: "/img/menuPics/rosatisAppetizers.jpg",
    link: "/menu/appetizers",
  },
  {
    id: 2,
    title: "Wings",
    imageUrl: "/img/menuPics/RosatisWings.jpg",
    link: "/menu/wings",
  },
  {
    id: 3,
    title: "Salads",
    imageUrl: "/img/menuPics/rosatiSalads.jpg",
    link: "/menu/salads",
  },
  {
    id: 4,
    title: "Pizza",
    imageUrl: "/img/menuPics/rosatisPizza.jpg",
    link: "/menu/pizza",
  },
  {
    id: 5,
    title: "Pastas",
    imageUrl: "/img/menuPics/rosatiPasta.jpg",
    link: "/menu/pastas",
  },
  {
    id: 6,
    title: "Sandwiches",
    imageUrl: "/img/menuPics/rosatiSandwiches.jpg",
    ...
    <div className="grid grid-cols-1 gap-4 p-4 sm:grid-cols-2 lg:grid-cols-3 px-10 mt-5">
      {cards.map((card) => (
        <Link
          href={card.link}
          key={card.id}
          className="block bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden"
        >
          <Image
            src={card.imageUrl}
            alt={card.title}
